<x-app-layout>
    <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
        <div>
            <h1 class="page-title fw-medium fs-18 mb-2">Create New User</h1>
            <div class="">
                <nav>
...
<!-- 
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="file" class="form-control @error('profile_photo_path') is-invalid @enderror" id="profile_photo_path" name="profile_photo_path" accept="image/*">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="is_uploader" name="is_uploader" value="1" {{ old('is_uploader') ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="is_query_admin" name="is_query_admin" value="1" {{ old('is_query_admin') ? 'checked' : '' }}>
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="two_factor_enabled" name="two_factor_enabled" value="1" {{ old('two_factor_enabled') ? 'checked' : '' }}>
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="is_banned" name="is_banned" value="1" {{ old('is_banned') ? 'checked' : '' }}>
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="is_suspended" name="is_suspended" value="1" {{ old('is_suspended') ? 'checked' : '' }}>
