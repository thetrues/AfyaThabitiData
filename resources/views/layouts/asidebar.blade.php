            ...
            <ul class="main-menu">
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a href="index-5.html" class="side-menu__item">Crypto</a>
                        </li>
                        <li class="slide">
                            <a href="index-6.html" class="side-menu__item">HRM</a>
                        </li>
                        <li class="slide">
                        ...
                        <li class="slide">
                            <a href="index-11.html" class="side-menu__item">School</a>
                        </li>
                        <li class="slide">
                            <a href="index-12.html" class="side-menu__item">Medical</a>
                        </li>
                        <li class="slide">
                            <a href="index-13.html" class="side-menu__item">POS System</a>
                        </li>
                        <li class="slide">
                            <a href="index-14.html" class="side-menu__item">Podcast</a>
                        </li>
                        <li class="slide">
                ...
                <!-- End::slide__category -->
                 ...
                 <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label">TX New</span>
                        <i class="ri-arrow-right-s-line side-menu__angle"></i>
                    </a>
                    <ul class="slide-menu child1 mega-menu">
                        <li class="slide side-menu__label1">
                            <a href="javascript:void(0)">TX New</a>
                        </li>
                        <li class="slide">
                            <a href="badge.html" class="side-menu__item">TX New Status</a>
                        </li>
                        <li class="slide">
                            <a href="alerts.html" class="side-menu__item">TX New Stats</a>
                        </li>
