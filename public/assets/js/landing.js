...
function switcherClick() {
  ...
  let primaryColor1Var = primaryDefaultColor1Btn.addEventListener(
    "click",
    () => {
      localStorage.setItem("primaryRGB", "28, 102, 215");
      html.style.setProperty("--primary-rgb", `28, 102, 215`);
      updateColors();
    }
  );
  let primaryColor2Var = primaryDefaultColor2Btn.addEventListener(
    "click",
    () => {
      localStorage.setItem("primaryRGB", "35, 144, 190");
      html.style.setProperty("--primary-rgb", `35, 144, 190`);
      updateColors();
    }
  );
  let primaryColor3Var = primaryDefaultColor3Btn.addEventListener(
    "click",
    () => {
      localStorage.setItem("primaryRGB", "81, 96, 250");
      html.style.setProperty("--primary-rgb", `81, 96, 250`);
      updateColors();
    }
  );
  ...
  let primaryColor5Var = primaryDefaultColor5Btn.addEventListener(
    "click",
    () => {
      localStorage.setItem("primaryRGB", "143, 32, 133");
      html.style.setProperty("--primary-rgb", `143, 32, 133`);
      updateColors();
    }
  );
