(function () {
  ...
  if (localStorage.vertixlayout) {
    let html = document.querySelector("html");
    html.setAttribute("data-nav-layout", "horizontal");
    document.querySelector("html").setAttribute("data-menu-styles", "light");
  }
  if (localStorage.getItem("vertixlayout") == "horizontal") {
    document
      .querySelector("html")
  ...
  function localStorageBackup() {
    ...
    if (localStorage.vertixdarktheme) {
      let html = document.querySelector("html");
      html.setAttribute("data-theme-mode", "dark");
    }
    if (localStorage.vertixlayout) {
      let html = document.querySelector("html");
      let layoutValue = localStorage.getItem("vertixlayout");
      html.setAttribute("data-nav-layout", "horizontal");
      setTimeout(() => {
        clearNavDropdown();
      }, 1000);
    ...
    if (localStorage.vertixverticalstyles) {
      let html = document.querySelector("html");
      let verticalStyles = localStorage.getItem("vertixverticalstyles");

      if (verticalStyles == "default") {
        html.setAttribute("data-vertical-style", "default");
        localStorage.removeItem("vertixnavstyles");
      }
        ...
        setTimeout(() => {
          ...
          menuSlideItem.forEach((e) => {
            ...
            e.addEventListener("mouseenter", () => {
              if (localStorage.vertixverticalstyles == "doublemenu") {
    ...
    if (localStorage.vertixnavstyles) {
      let html = document.querySelector("html");
      let navStyles = localStorage.getItem("vertixnavstyles");
      if (navStyles == "menu-click") {
        html.setAttribute("data-nav-style", "menu-click");
        localStorage.removeItem("vertixverticalstyles");
    ...
    if (localStorage.vertixclassic) {
      let html = document.querySelector("html");
      html.setAttribute("data-page-style", "classic");
    }
    if (localStorage.vertixmodern) {
      let html = document.querySelector("html");
      html.setAttribute("data-page-style", "modern");
    }
    if (localStorage.vertixboxed) {
      let html = document.querySelector("html");
      html.setAttribute("data-width", "boxed");
    }
    if (localStorage.vertixfullwidth) {
      let html = document.querySelector("html");
      html.setAttribute("data-width", "fullwidth");
    }
    if (localStorage.vertixheaderfixed) {
      let html = document.querySelector("html");
      html.setAttribute("data-header-position", "fixed");
    }
    if (localStorage.vertixheaderscrollable) {
      let html = document.querySelector("html");
      html.setAttribute("data-header-position", "scrollable");
    }
    if (localStorage.vertixmenufixed) {
      let html = document.querySelector("html");
      html.setAttribute("data-menu-position", "fixed");
    }
    if (localStorage.vertixmenuscrollable) {
      let html = document.querySelector("html");
      html.setAttribute("data-menu-position", "scrollable");
    }
    if (localStorage.vertixMenu) {
      let html = document.querySelector("html");
      let menuValue = localStorage.getItem("vertixMenu");
      switch (menuValue) {
        case "light":
    ...
    if (localStorage.vertixHeader) {
      let html = document.querySelector("html");
      let headerValue = localStorage.getItem("vertixHeader");
      switch (headerValue) {
        case "light":
