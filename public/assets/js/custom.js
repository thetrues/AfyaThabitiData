(function () {
  ...
  function toggleTheme() {
    ...
    if (html.getAttribute("data-theme-mode") === "dark") {
      ...
      localStorage.removeItem("vertixdarktheme");
      localStorage.removeItem("vertixMenu");
      localStorage.removeItem("vertixHeader");
      ...
      document.querySelector("#switcher-background1").checked = false;
      document.querySelector("#switcher-background").checked = false;
      localStorage.setItem("vertixdarktheme", "true");
      localStorage.setItem("vertixMenu", "dark");
      localStorage.setItem("vertixHeader", "dark");
      localStorage.removeItem("bodylightRGB");
      localStorage.removeItem("bodyBgRGB");
    }
  }
