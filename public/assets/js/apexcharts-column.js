(function () {
    ...
    var options = {
        ...
        colors: ["#8274ff", "#ff6937", "#58c437", "#ff9703"],
        responsive: [{
            breakpoint: 480,
            options: {
                legend: {
    ...
    var colors = ['#8274ff', '#ff6937', '#58c437', '#ff9703', '#fe5454', '#4195f9', '#7b76fe'];
    ...
    var options = {
        ...
        colors: ['#8274ff', '#ff6937', '#58c437', '#ff9703', '#4195f9', '#fb4e58', '#7b76fe', '#fe549b'],
        plotOptions: {
            bar: {
                columnWidth: '45%',
                distributed: true,
